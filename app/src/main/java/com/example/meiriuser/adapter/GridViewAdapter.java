...
public class GridViewAdapter extends BaseAdapter {
    ...
    public GridViewAdapter(Context context, List<TaskOutFoodClassicModel.DataBean> mDatas, int curIndex, int pageSize) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tv.setText(mDatas.get(pos).getCat_name());
