...
public class AddressAdapter extends BaseAdapter {
    ...
    private List<MapAddressModel.PredictionsBean> mListTips;

    public AddressAdapter(Context context, List<MapAddressModel.PredictionsBean> tipList) {
        mContext = context;
        mListTips = tipList;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.mName.setText(mListTips.get(i).getDescription());
        holder.mAddress.setText(mListTips.get(i).getStructured_formatting().getSecondary_text());
