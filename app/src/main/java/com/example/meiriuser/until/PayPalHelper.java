...
//你所注册的APP Id
    private static final String CONFIG_CLIENT_ID = "AUb77l3dMoY6JRhUnxPkb8_YCxRPQlWZtOyDVb4gV9a6Y5G0KKDHaUmBusUqSW_qIrpBLxpQW8y4Psap";
...
//.merchantUserAgreementUri(Uri.parse("https://www.example.com/legal"));
     ...
     * @param context
     */
    public void doPayPalPay(Context context,String totalPrice,String shopName) {

        PayPalPayment thingToBuy = getStuffToBuy(PayPalPayment.PAYMENT_INTENT_SALE,totalPrice,shopName);
    ...
    /*
         ...
         */
    private PayPalPayment getStuffToBuy(String paymentIntent,String totalPrice,String shopName) {

      /*  addToCart(new Product("1", "sinny", "fredric_sinny", null, new BigDecimal(1), "1232131"));*/
      /*  PayPalPayment thingsToBuy = prepareFinalCart();*/

        PayPalPayment payment = new PayPalPayment(new BigDecimal(totalPrice), "AUD", shopName, paymentIntent);
        return payment;
    }
