...
public class OrderNoFinishFragment extends BaseFragment {
    ...
    public void initData() {
        ...
        orderAdapter = new OrderAdapter(getContext(), orderModelList, "未完成", new OrderAdapter.onItemOrderClick() {
            @Override
            ...
            public void onSeeOrderClick(String order_id,String payStatus,String orderStatus,String shipping) {//查看订单详情
                if(payStatus.equals("0")|| payStatus.equals("1")){
            ...
            @Override
            public void onCancelOrderClick(String order_id,int postion) {//取消订单
    ...
    public void getOrderList(int pageNo,int flag) {
        ...
        OkHttpUtils
                .get()
                .url(url)
                .addParams("status", Constant.ORDER_NO_FINISH)
